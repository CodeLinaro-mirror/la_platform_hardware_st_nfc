...
extern struct stpropnci_state {
  ...
  *****************************/
  ...
  // Keep last NCI_MSG_RF_EE_DISCOVERY_REQ as a method to trigger a LMRT resending.
  ...
  //NFC service will restart following CORE_RESET_NTF
  bool nfc_recovery;
  uint8_t nfc_recovery_hint;
...
#define IS_HW_54L_OR_MORE_RECENT_FAMILY() \
  (HW_VERSION >= HW_VERSION_ST54L)
